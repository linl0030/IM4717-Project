...
(13,'LAGKAPTEN/MILLBERGET / BILLY/OXBERG',596,'Desk and storage combination, and swivel chair black-brown/black','Make sure you have a great day at work – at home. This set has everything you need for a complete and functional workspace with a chair, desk and storage. Ready to use in a flash!'),
...
(52,'IDÅSEN',349,	'Cabinet with doors and drawers, 80x47x119 cm','Use the robust IDÅSEN cabinet to store plenty of work things close to your workspace – while ROTHULT smart lock keeps papers and other items safe. Goes perfectly with other furniture in the IDÅSEN series.'),
